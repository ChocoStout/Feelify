...
## #####################################################
CREATE TABLE Paises(
  idPais INT NOT NULL AUTO_INCREMENT, ##id del Pais
...
CREATE TABLE TiposUsuario(
  idTipoUsuario INT NOT NULL AUTO_INCREMENT, ##id del tipo de usuario
...
CREATE TABLE Estados(
  idEstado INT NOT NULL AUTO_INCREMENT, ##id del estado
...
CREATE TABLE Usuarios(
  idUsuario INT NOT NULL AUTO_INCREMENT, ##id del usuario
  ...
  Password BLOB NOT NULL, ##Contraseña del usuario, debe ser BLOB para usar encriptacion AES (https://mysqldatabaseadministration.blogspot.com/2006/08/storing#passwords#in#mysql.html)
...
CREATE TABLE Actividades(
  idActividad INT NOT NULL AUTO_INCREMENT, ##id de la activdad 
...
CREATE TABLE Sentimientos(
  idSentimiento INT NOT NULL AUTO_INCREMENT, ##id del sentimiento
...
CREATE TABLE UsuariosSentimientos(
  ...
  Fecha DATETIME NULL, ##Fecha y hora en la que se registro el sentimiento
...
CREATE TABLE UsuariosActividades(
  ...
  Fecha DATETIME NOT NULL, ##Fecha y hora de la actividad
...
CREATE TABLE Artistas(
  idArtista INT NOT NULL AUTO_INCREMENT, ##id del artista
...
## #####################################################
CREATE TABLE Albums(
  idAlbum INT NOT NULL AUTO_INCREMENT, ##id del album
  Nombre VARCHAR(45) NOT NULL, ##Nombre del album
  Imagen TEXT, ##Ruta en la que esta almacenada la imagen
...
CREATE TABLE Canciones(
  idCancion INT NOT NULL AUTO_INCREMENT, ##id de la cancion
...
CREATE TABLE Generos(
  idGenero INT NOT NULL AUTO_INCREMENT, ##id del genero
...
CREATE TABLE Playlists(
  idPlaylist INT NOT NULL AUTO_INCREMENT, ##id de la playlist
  Nombre VARCHAR(45) NOT NULL, ##Nombre de la playlist
  Descripcion TINYTEXT NOT NULL, ##Descripcion de la playlist
  Imagen TEXT, ##Ruta en la que se encuentra la imagen de la playlist
